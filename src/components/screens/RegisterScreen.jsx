...
import { ModalErrorMessage, ModalSuccessMessage } from '../alerts';
...
export const RegisterScreen = () => {
   ...
   const { startRegister, errorMessage, msg } = useAuthStore();
   const [formRegisterValuesState, setFormRegisterValuesState, reset] = useForm(initState);
   const {
      firstName,
      lastName,
      email,
      ...
      rPassword,
      termsAndConditions
   } = formRegisterValuesState;

   const handleRegister = async (e) => {

      e.preventDefault();

      const result = await startRegister(formRegisterValuesState);

      if (result)
         reset(initState);
      else
         reset(formRegisterValuesState);
   }
      ...
      <div className="flex min-h-screen items-center justify-center">
         <div className="relative flex flex-col rounded-xl bg-transparent bg-clip-border text-gray-700 shadow-none">
            ...
            <p className="mt-1 block font-sans text-base font-normal leading-relaxed text-gray-700 antialiased">
               Coloca tus datos para registrarte.
            </p>
               ...
               <div className="mb-4 flex flex-col gap-6">
                  <div className="relative h-11 w-full min-w-[200px]">
                     <input
                        ...
                        name='firstName'
                        value={firstName}
                        onChange={setFormRegisterValuesState}
                        placeholder=" "
                        autoComplete='off'
                     />
               ...
               <div className="inline-flex items-center">
                  ...
                  >
                     <input
                        ...
                        onChange={e => { setFormRegisterValuesState(e, 'checkbox') }}
                     />
         ...
         <ModalSuccessMessage trigger={ msg } functionToTrigger={() => {clearMessages(); navigate('login') }} message={ msg } />
